    ...
    const [lifestyle, setLifestyle] = React.useState('');
      ...
      const handleSubmit = async (e) => {
        ...
        if (file) {
          ...
          try {
            await axios.post("https://blogapi-web.herokuapp.com/api/upload", data);
          } catch (err) {}
        }
        try {
          const res = await axios.post("https://blogapi-web.herokuapp.com/api/posts", newPost);
          window.location.replace("https://blogapi-web.herokuapp.com/api/post" + res.data._id);
        } catch (err) {}
      };
    return (
